...
/*------------------------------
Вывод для text slider
-------------------------------*/
$TextSlider = db_row("SELECT * FROM text_slider WHERE stranica='".$stranica."' ORDER BY nomer")["item"];
if($TextSlider["small_title1"]){ $TextSlider["small_title1"] = json_decode($TextSlider["small_title1"], true); }
if($TextSlider["small_title2"]){ $TextSlider["small_title2"] = json_decode($TextSlider["small_title2"], true); }
...
<!--banner-->
<? if($TextSlider): ?>
<div class="banner" style="background-image:url(FILES/forTextSlider/big/<? echo $TextSlider["photo"]; ?>);">
	<div class="container">
		<section class="rw-wrapper">
			<h1 class="rw-sentence">
				<span><? echo $TextSlider["big_title"] ?></span>
                <? if($TextSlider["small_title1"]): ?>
				<div class="rw-words rw-words-1">
                    <? foreach ($TextSlider["small_title1"] as $item) { ?>
					<span><? echo $item ?></span>
                    <? } ?>
				</div>
                <? endif; ?>
                <? if($TextSlider["small_title2"]): ?>
				<div class="rw-words rw-words-2">
                    <? foreach ($TextSlider["small_title2"] as $item) { ?>
					<span><? echo $item ?></span>
                    <? } ?>
				</div>
                <? endif; ?>
	...
	<div class="container">
		...
		<div class="brand">
			...
			<div class="col-md-3 brand-grid">
				<img src="FILES/partners/big/<? echo $item["photo"] ?>" class="img-responsive" alt="<? echo $item["href_title"] ?>">
			</div>
            <? } ?>
			<div class="clearfix"></div>
		</div>
...
<? if(is_admin()): ?>
	...
	<section id="admBar">
		...
		<ul class="listBtns">
            <? include_once("blocks/face/forAdmBar.php"); ?>
			<li>
