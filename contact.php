...
if($PageInfo["dopRows"]){$PageInfo["dopRows"] = json_decode($PageInfo["dopRows"], true);}
...
<div class="contact">
		...
		<div class="container">
			<div class="col-md-6 contact-left">
				...
				<div class="address">
					...
					<? if($PageInfo["dopRows"]["address"]){ ?>
					<div class=" address-grid">
						<i class="glyphicon glyphicon-map-marker"></i>
						<div class="address1">
							<h3>Address</h3>
							<p><? echo @$PageInfo["dopRows"]["address"]?> </p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<? } ?>
					<div class=" address-grid ">
						<?if($PageInfo["dopRows"]["phone"]){  ?>
						<i class="glyphicon glyphicon-phone"></i>
						<div class="address1">
							<h3>Our Phone:<h3>
									<p><? echo @$PageInfo["dopRows"]["phone"]?> </p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<? } ?>
					<?if($PageInfo["dopRows"]["email"]){  ?>
					<div class=" address-grid ">
						<i class="glyphicon glyphicon-envelope"></i>
						<div class="address1">
							<h3>Email:</h3>
							<p><a href="mailto:<? echo @$PageInfo["email"]?> "> <? echo @$PageInfo["dopRows"]["email"]?> </a></p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<? } ?>
					<?if($PageInfo["dopRows"]["hours"]){  ?>
					<div class=" address-grid ">
						<i class="glyphicon glyphicon-bell"></i>
						<div class="address1">
							<h3>Open Hours:</h3>
							<p><? echo @$PageInfo["dopRows"]["hours"]?> </p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<? } ?>
	...
	<?if($PageInfo["dopRows"]["map"]){  ?>
	<div class="map">
		<? echo @$PageInfo["dopRows"]["map"]?>
	</div>
	<? } ?>
</div>
