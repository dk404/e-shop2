...
/*
  ...
  после email вы создаете дополнительный рессурс c указанным id. ID рессурса может быть любая строка из цифр и букв латинского алфавита.
...
// если установлено подтверждение о доставке, берем адрес куда слать уведомление из адрес для ответа, либо из From
    ...
    public function ValidEmail($address)
    {
        ...
        */
            ...
            if(!preg_match($pattern, $address)) { return false; }
            else 
            {
                return true;
            }          
